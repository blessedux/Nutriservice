...
export function getIndustriaProductosSectionCopy(
  ...
  return (
    copyBySlug[industrySlug] ?? {
      title: `Soluciones funcionales para ${industryName.toLowerCase()}`,
