...
import { AVES_VIDEO_WEBM } from "@/lib/productos-division-media";
...
type IndustriaAvicolaPageProps = {
  industry: Industry;
};

export default function IndustriaAvicolaPage({
  industry,
}: IndustriaAvicolaPageProps) {
      ...
      <div className="relative z-10">
        ...
        <section className="px-6 py-12 sm:px-10 lg:px-12">
          <div className="mx-auto max-w-3xl">
            <DivisionContactBlock division="aves" />
          </div>
        </section>
