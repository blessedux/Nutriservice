...
export default function Footer() {
  ...
  return (
    ...
    >
      ...
      `}} />
      <div
        className="pointer-events-none absolute inset-0 bg-no-repeat max-lg:bg-[length:auto_200%] max-lg:bg-[position:78%_66%] lg:bg-cover lg:bg-[position:right_bottom] footer-bg-custom"
